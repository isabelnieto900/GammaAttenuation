...
# Ejecuta análisif [ ! -f "/home/sofi/REPOS/GammaAttenuation/results/multi_thickness/thickness_analysis_data.csv" ]; thens ROOT + visualización Python
...
echo "  python analysis/plot_multi_thickness.py"
echo ""