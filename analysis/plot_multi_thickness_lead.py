#!/usr/bin/env python3
"""
Visualización Análisis de atenuación gamma vs espesor para plomo
...
def main():
    ...
    data_file = "/home/isabel/GammaAttenuation/results/multi_thickness/thickness_lead_analysis_data.csv"
    results_file = "/home/isabel/GammaAttenuation/results/multi_thickness/fit_lead_results.txt"
    
    if not os.path.exists(data_file):
        print(f"INFO: Datos de multi-espesor para plomo no encontrados.")
        print(f"Para generar estos datos, ejecutar:")
        print(f"./scripts/run_multi_thickness_lead.sh")
        print(f"./build/gammaAtt analysis/multi_thickness_lead_analysis.C")
        return
    ...
    mu_measured = 0.0601  # valor actualizado para plomo
    mu_error = 0.0002
    ...
    fig.suptitle('Análisis Multi-Espesor - Atenuación Gamma en Plomo Pbo', 
    ...
    nist_mu = 0.1311  # cm⁻¹ para plomo a 662 keV (NIST)
    ...
    base_name = "results/multi_thickness/thickness_lead_analysis_elegant"
