 ...
 * Análisis de atenuación gamma vs energía para concreto
 * Estudio de coeficientes de atenuación másicos
 * Material: Concreto estándar (G4_CONCRETE_SKELETAL_ICRP)
 * Autor: Isabel Nieto, PoPPop21
 * Fecha: Octubre 2025
 * --------------------------------------
 * Uso: root -l -b -q "multi_energy_concrete_analysis.C"
 */

void multi_energy_concrete_analysis()
{
    ...
    printf("\nAnalisis Multi-Energía - Concreto Esquelético\n");
    printf("============================================\n");

    // Datos NIST para concreto esquelético (coeficiente de atenuación másico μ/ρ en cm²/g)
    ...
    // Datos NIST correspondientes para concreto esquelético (interpolados donde sea necesario)
    ...
    double density = 1.05;  // g/cm³ para concreto esquelético

    printf("Parámetros de simulación:\n");
    printf("- Material: Concreto estándar\n");
    ...
    {
        TString filename = Form("results/data_energy_concrete_%.0fkeV.root", energias_keV[i]);
    ...
    FILE *csvFile = fopen("results/multi_energy/energy_spectrum_concrete_comparison.csv", "w");
    ...
    FILE *resultsFile = fopen("results/multi_energy/concrete_analysis_results.txt", "w");
    fprintf(resultsFile, "Multi-Energy Analysis Results - Concreto Esquelético\n");
    fprintf(resultsFile, "==================================================\n");
    fprintf(resultsFile, "Material: Concreto estándar (G4_CONCRETE_SKELETAL_ICRP)\n");
    ...
    printf("\nDatos guardados en:\n");
    printf("- results/multi_energy/energy_spectrum_concrete_comparison.csv\n");
    printf("- results/multi_energy/concrete_analysis_results.txt\n");
