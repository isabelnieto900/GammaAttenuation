...
def plot_energy_spectrum():
    ...
    csv_file = "results/multi_energy/energy_spectrum_concrete_comparison.csv"
    ...
    try:
        ...
        ax1.set_title('Coeficientes de Atenuación Másico del Concreto\n(Espectro Completo)', fontweight='bold')
        ...
        # Guardar la gráfica
        output_file = "results/multi_energy/energy_spectrum_concrete_analysis.png"
        ...
        plt.title('Coeficientes de Atenuación Másico del Concreto\nComparación GEANT4 vs NIST', 
        ...
        output_file2 = "results/multi_energy/nist_style_concrete_comparison.png"
