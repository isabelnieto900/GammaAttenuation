 ...
 * Análisis de atenuación gamma vs energía para polietileno
...
void multi_energy_analysis()
{
    ...
    printf("\nAnalisis Multi-Energía - Polietileno\n");
    printf("==============================\n");

    // Datos NIST reales para el polietileno líquida (coeficiente de atenuación másico μ/ρ en cm²/g)
    // Fuente: NIST XCOM Database - Polyethylene, Liquid
    ...
    double density = 0.95;   // g/cm³ para polietileno

    printf("Parámetros de simulación:\n");
    printf("- Material: Polietileno (HDPE)\n");
    ...
    for (int i = 0; i < nEnergies; i++)
    {
        TString filename = Form("results/data_energy_polyethylene_%.0fkeV.root", energias_keV[i]);
