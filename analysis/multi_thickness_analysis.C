 ...
 * Fecha: Octubre 2025
 * --------------------------------------
 * Uso: root -l -b -q "multi_thickness_analysis.C"
 */

void multi_thickness_analysis()
{
    ...
    FILE *csvFile = fopen("/home/sofi/REPOS/GammaAttenuation/results/multi_thickness/thickness_analysis_data.csv", "w");
    ...
    FILE *resultsFile = fopen("/home/sofi/REPOS/GammaAttenuation/results/multi_thickness/fit_results.txt", "w");
    ...
    printf("\nDatos guardados en:\n");
    printf("- results/multi_thickness/thickness_analysis_data.csv\n");
    printf("- results/multi_thickness/fit_results.txt\n");
