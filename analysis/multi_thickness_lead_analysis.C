 ...
 * Fecha: Octubre 2025
 * --------------------------------------
 * Uso: root -l -b -q "multi_thickness_lead_analysis.C"
 */

void multi_thickness_lead_analysis()
{
    ...
    FILE *csvFile = fopen("/home/isabel/GammaAttenuation/results/multi_thickness/thickness_lead_analysis_data.csv", "w");
    ...
    FILE *resultsFile = fopen("/home/isabel/GammaAttenuation/results/multi_thickness/fit_lead_results.txt", "w");
    fprintf(resultsFile, "Multi-Thickness Analysis Results\n");
    fprintf(resultsFile, "==============================\n");
    fprintf(resultsFile, "Material: Compact Lead\n");
    ...
    printf("\nDatos guardados en:\n");
    printf("- results/multi_thickness/thickness_lead_analysis_data.csv\n");
    printf("- results/multi_thickness/fit_lead_results.txt\n");
