 ...
 * Análisis de atenuación gamma vs espesor para concreto
 * Estudio de la Ley de Beer-Lambert
 * Material: Concreto estándar
 * Autor: Isabel Nieto, PoPPop21
 * Fecha: Octubre 2025
 * --------------------------------------
 * Uso: root -l -b -q "multi_thickness_concrete_analysis.C"
 */

void multi_thickness_concrete_analysis()
{
    ...
    printf("\nAnalisis Multi-Espesor - Concreto Esquelético\n");
    printf("===========================================\n");
    ...
    FILE *csvFile = fopen("/home/isabel/GammaAttenuation/results/multi_thickness/thickness_concrete_analysis_data.csv", "w");
    ...
    FILE *resultsFile = fopen("/home/isabel/GammaAttenuation/results/multi_thickness/fit_concrete_results.txt", "w");
    fprintf(resultsFile, "Multi-Thickness Analysis Results\n");
    fprintf(resultsFile, "==============================\n");
    fprintf(resultsFile, "Material: Skeletal Concrete\n");
    ...
    printf("\nDatos guardados en:\n");
    printf("- results/multi_thickness/thickness_concrete_analysis_data.csv\n");
    printf("- results/multi_thickness/fit_concrete_results.txt\n");
