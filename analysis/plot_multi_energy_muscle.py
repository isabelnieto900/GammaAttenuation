...
def plot_energy_spectrum():
    ...
    csv_file = "results/multi_energy/energy_spectrum_muscle_comparison.csv"
    ...
    try:
        ...
        ax1.set_title('Coeficientes de Atenuación Másico del Músculo\n(Espectro Completo)', fontweight='bold')
        ...
        # Guardar la gráfica
        output_file = "results/multi_energy/energy_spectrum_muscle_analysis.png"
        ...
        plt.title('Coeficientes de Atenuación Másico del Músculo\nComparación GEANT4 vs NIST', 
        ...
        output_file2 = "results/multi_energy/nist_style_muscle_comparison.png"
