...
def main():
    ...
    data_file = "/home/isabel/GammaAttenuation/results/multi_thickness/thickness_muscle_analysis_data.csv"
    results_file = "/home/isabel/GammaAttenuation/results/multi_thickness/fit_muscle_results.txt"
    
    if not os.path.exists(data_file):
        print(f"INFO: Datos de multi-espesor para músculo no encontrados.")
        print(f"Para generar estos datos, ejecutar:")
        print(f"./scripts/run_multi_thickness_muscle.sh")
        print(f"./build/gammaAtt analysis/multi_thickness_muscle_analysis.C")
        return
    ...
    mu_measured = 0.0358  # valor actualizado para músculo
    mu_error = 0.0002
    ...
    nist_mu = 0.0781  # cm⁻¹ para músculo a 662 keV (NIST)
